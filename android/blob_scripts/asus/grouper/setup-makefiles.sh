...
OUTDIR=$OUTVENDOR/trusted_logic/$DEVICE
mkdir -p ../../../$OUTDIR/proprietary
MAKEFILE=../../../$OUTDIR/proprietary/Android.mk
...
OUTDIR=$OUTVENDOR/unknown/$DEVICE
mkdir -p ../../../$OUTDIR/proprietary
MAKEFILE=../../../$OUTDIR/proprietary/Android.mk
...
# TRUSTED_LOGIC
TARGET=../../../$OUTVENDOR/trusted_logic/$DEVICE/proprietary
mv $ASUSDIR/tf_daemon $TARGET

# UNKNOWN
TARGET=../../../$OUTVENDOR/unkown/$DEVICE/proprietary
mv $ASUSDIR/sensors-config $TARGET
mv $ASUSDIR/asound.conf $TARGET
mv $ASUSDIR/gpsconfig.xml $TARGET
mv $ASUSDIR/gps.tegra3.so $TARGET
mv $ASUSDIR/keystore.grouper.so $TARGET
mv $ASUSDIR/sensors.grouper.so $TARGET
